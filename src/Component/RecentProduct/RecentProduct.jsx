...
export default function RecentProduct() {
  ...
  async function handellWishlist(id) {
    ...
    if (res.data?.status === "success") {
      ...
      setWishlistStatus((prev) => ({ ...prev, [id]: !prev[id] }));
          ...
          <div className="radio-inputs">
            ...
            <div className="product-title">
              <span
                ...
                onClick={() =>
                  wishlistStatus[product.id] || TargetWishlist.filter((item)=>item== product.id)== product.id? deletItem(product.id): handellWishlist(product.id)
                }
              >
